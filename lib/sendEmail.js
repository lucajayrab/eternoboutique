    ...
    <table width="100%" style="max-width: 600px; background-color: #d8d3c2 !important;" class="header-bg">
      ...
      <tr>
        <td align="center" style="padding: 40px 20px;" class="header-bg">
          <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ETERNO%20Website%20Logo-VksFhV49RBsuiRIrDi47Z6YM8eaFLR.png" alt="ETERNO" width="200" style="display: block; border: 0;">
        </td>
      </tr>
      ...
      <tr>
        <td style="padding: 0; font-size: 0; line-height: 0;">
          <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Screenshot%202025-04-29%20at%2009.15.24.jpg-IrEoijyUx0vcCG12YHbf7Tx7GEfvP5.jpeg" width="600" alt="ETERNO Man on Boat" style="width: 100%; max-width: 600px; display: block;">
        </td>
      </tr>
      ...
      <tr>
        <td align="center" style="padding: 20px; font-size: 12px; background-color: #d8d3c2 !important;" class="header-bg">
          ...
          <p style="margin: 0 0 10px 0; color: #666666 !important;" class="text-color">
...
// Notification email HTML template - also updated with the hosted logo
    ...
    <table width="100%" style="max-width: 600px; background-color: #d8d3c2;">
      ...
      <tr>
        <td align="center" style="padding: 30px 20px;">
          <img src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ETERNO%20Website%20Logo-VksFhV49RBsuiRIrDi47Z6YM8eaFLR.png" alt="ETERNO" width="150" style="display: block; border: 0;">
        </td>
      </tr>
      ...
      <tr>
        <td align="center" style="padding: 20px; font-size: 12px; background-color: #d8d3c2;">
          <p style="margin: 0 0 10px 0;">&copy; 2024 ETERNO. All Rights Reserved.</p>
          <p style="margin: 0; color: #666666;">
            Clifford St, London, W1S 4JY
          </p>
        </td>
