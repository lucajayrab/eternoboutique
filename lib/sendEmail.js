    ...
    <table width="100%" style="max-width: 600px; background-color: #d8d3c2 !important;" class="header-bg">
      ...
      <tr>
        <td align="center" style="padding: 40px 20px;" class="header-bg">
          <img src="https://hbnpsgpm7ka33yva.public.blob.vercel-storage.com/ETERNO%20Website%20Logo-i1zsaaao2lf5Zfk5uUfw31YkKv3QjC.svg" alt="ETERNO" width="200" style="display: block; border: 0;">
        </td>
      </tr>
      ...
      <tr>
        <td align="center" style="padding: 20px; font-size: 12px; background-color: #d8d3c2 !important;" class="header-bg">
          ...
          <p style="margin: 0; color: #666666 !important;" class="text-color">
            <a href="mailto:enquiries@eternotailoring.com" style="color: #666666 !important; text-decoration: underline; margin: 0 10px;" class="text-color">Contact Us</a> | 
            <a href="{{unsubscribe_url}}" style="color: #666666 !important; text-decoration: underline; margin: 0 10px;" aria-label="Unsubscribe from ETERNO emails" class="text-color">Unsubscribe</a>
          </p>
        </td>
      </tr>
    </table>
    ...
    <table width="100%" style="max-width: 600px; background-color: #d8d3c2;">
      ...
      <tr>
        <td align="center" style="padding: 30px 20px;">
          <img src="https://hbnpsgpm7ka33yva.public.blob.vercel-storage.com/ETERNO%20Website%20Logo-i1zsaaao2lf5Zfk5uUfw31YkKv3QjC.svg" alt="ETERNO" width="150" style="display: block; border: 0;">
        </td>
      </tr>
